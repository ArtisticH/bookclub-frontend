      ...
      <div className={cx("final")}>
        ...
        <div className={cx("final-main")}>
          <img
            ...
            onClick={Download}
            className={cx("img")}
            src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/${model}/${original[choosen].main}.jpeg`}
            alt="final"
          />
        </div>
      </div>
      ...
      {types === "music" ? (
        <>
          <div className={cx("icon-img-box")}>
            <img className={cx("img")} src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/icon/music.png`} alt="music" />
          </div>
  ...
  return (
    <div className={cx("top-img")}>
      ...
      >
        <img
          className={cx("img")}
          src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/${model}/${main[index]}.jpeg`}
          alt="img"
        />
      </div>
    </div>
    ...
    <div className={cx("top-info")}>
      {types === "music" && (
        <>
          <audio
            className={cx("audio")}
            src={`${process.env.REACT_APP_WAITLIST_API_URL}/audio/${model}/${main[index]}.mp3`}
            ref={Audio}
            onEnded={ended}
          ></audio>
          <div className={cx("play")} onClick={top ? Pause : Play}>
            <img
              className={cx("img")}
              src={top ? `${process.env.REACT_APP_WAITLIST_API_URL}/img/icon/pause.png` : `${process.env.REACT_APP_WAITLIST_API_URL}/img/icon/play.png`}
              alt="play"
            />
          </div>
        </>
  ...
  return (
    <div className={cx("bot-img")}>
      ...
      >
        <img
          className={cx("img")}
          src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/${model}/${main[index + 1]}.jpeg`}
          alt="img"
        />
      </div>
    </div>
    ...
    <div className={cx("bot-info")}>
      {types === "music" && (
        <>
          <audio
            className={cx("audio")}
            src={`${process.env.REACT_APP_WAITLIST_API_URL}/audio/${model}/${main[index + 1]}.mp3`}
            ref={Audio}
            onEnded={ended}
          ></audio>
          <div className={cx("play")} onClick={bottom ? Pause : Play}>
            <img
              className={cx("img")}
              src={bottom ? `${process.env.REACT_APP_WAITLIST_API_URL}/img/icon/pause.png` : `${process.env.REACT_APP_WAITLIST_API_URL}/img/icon/play.png`}
              alt="play"
            />
          </div>
        </>
