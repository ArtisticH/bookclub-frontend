        ...
        <>
          <div className={cx("links")}>
            <Link to="/books" style={{ width: "70px" }}>
              <img className="img" src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/icon/left-white-arrow.png`} />
            </Link>
        ...
        <div className={cx("left-main")}>
          <div className={cx("left-grid")}>
            <div className={cx("book-img")}>
              <img className="img" src={`${process.env.REACT_APP_WAITLIST_API_URL}/${book.img}`} alt="book-img" />
            </div>
        ...
        {review.overText && (
          <div className={cx("more")} onClick={ClickMore}>
            ...
            <img
              ...
              src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/icon/down-arrow.png`}
              alt="arrow"
            />
          </div>
        )}
        ...
        <div className={cx("heart")} onClick={ClickHeart}>
          <div className={cx("heart-img-box")}>
            <img
              ...
              src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/icon/heart.png`}
              alt="heart"
            />
            <img
  ...
  return (
    <form className={cx("form")} onSubmit={eidtClicked ? EditSubmit : Submit}>
      ...
      <div className={cx("form-book")}>
        <div>
          <img className={cx("img")} src={`${process.env.REACT_APP_WAITLIST_API_URL}/${book.img}`} alt="book" />
        </div>
