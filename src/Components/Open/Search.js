...
const ResultZone = ({ state, dispatch, user }) => {
  ...
  return (
    <div className={cx("result")}>
      ...
      <img src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/open/line.png`} alt="img" className={cx("line-top")} />
      <img src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/open/line.png`} alt="img" className={cx("line-bottom")} />
      <img src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/open/line.png`} alt="img" className={cx("line-left")} />
      <img src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/open/line.png`} alt="img" className={cx("line-right")} />
    </div>
  );
};
      ...
      <form className={cx("form")} onSubmit={Submit}>
        <div className={cx("select-zone")}>
          <img
            ...
            src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/open/search-select.png`}
            alt="img"
          />
          <select
            id="targets"
        ...
        <div className={cx("input-zone")}>
          <img
            ...
            src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/open/search-input.png`}
            alt="img"
          />
          <input
            ref={Input}
        ...
        <div className={cx("search-btn")}>
          <img
            ...
            src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/open/glasses.png`}
            alt="img"
          />
          <input
