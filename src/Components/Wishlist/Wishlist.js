  ...
  return (
    ...
    >
      <div className={cx("img-box")}>
        <img className="img" src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/icon/folder.png`} alt="folder" />
  ...
  return (
    <div className={cx("blank-menu")} style={style}>
      ...
      >
        ...
        <img
          className={cx("arrow")}
          src={`${process.env.REACT_APP_WAITLIST_API_URL}/img/icon/right-white-arrow.png`}
          alt="arrow"
        />
